...
A PONG game clone that features "power-ups", an "AI" opponent and a dynamic difficulty (based on the player's score). Made using Python with the PyGame module
